...
Select Environment: In the top-right corner, click the environment dropdown and select "NHS - Sandbox Copy."
Verify Variables: Click the Environment Quick Look icon. 
The following values are pre-configured for immediate execution:
